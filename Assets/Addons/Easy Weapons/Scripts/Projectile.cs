...
public class Projectile : MonoBehaviour
{
	...
	public float damage = 20;										// The amount of damage to be applied (only for Direct damage type)
	...
	private string seekTag = "Zombie";									// The projectile will seek gameobjects with this tag
